# see https://github.com/godot-addons/godot-object-pool
...
var prefix setget no_access_set, get_prefix

# Pool size on initialization
var size setget no_access_set, get_size

# Preloaded scene resource
var scene setget no_access_set, get_scene

# Dictionary of "alive" objects currently in-use.
# Using a dictionary for fast lookup/deletion
var alive = {} setget no_access_set, no_access_get

# Array of "dead" objects currently available for use
var dead = [] setget no_access_set, no_access_get
